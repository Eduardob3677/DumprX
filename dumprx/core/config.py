...
class Config:
    def __init__(self):
        ...
        self.output_dir = self.project_dir / "working"
        self.tmp_dir = self.project_dir / "working" / "tmp"
        ...
        self.ext4_partitions = [
            "system", "vendor", "cust", "odm", "oem", "factory", "product", 
            "xrom", "systemex", "oppo_product", "preload_common", 
            "hw_product", "product_h", "preas", "preavs"
        ]
    ...
    def _setup_paths(self):
        ...
        self.python_tools = {
            ...
            'afhdl': self.utils_dir / 'downloaders' / 'afh_dl.py',
        }
        
        self.bin_7zz = self._get_7zz_binary()
        
    def _get_7zz_binary(self):
        import shutil
        if shutil.which('7zz'):
            return '7zz'
    ...
    def get_github_token(self) -> str:
        token_file = self.project_dir / '.github_token'
